 ...
 */
export const MANAGEMENT_FEE = 0.18;
export const OPERATING_COST = 0.2;
 ...
 * maintenance, utilities and platform fees. This is the figure the brief's
 * 12–22% indicative range refers to, and it is never shown without its
 * footnote (see YIELD_CLAIM in brand.ts).
 */
